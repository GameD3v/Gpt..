...
#include <d3d11.h>         // Direct3D 11 temel tanımları için
#include <wrl/client.h>    // Microsoft::WRL::ComPtr için (Smart Pointer)
#include "CommonN3Structures.h" // Vertex yapılarınızı tanımlayan dosya
...
protected:
	...
	uint32_t                m_iFileFormatVersion; // Dosya formatı sürümü (CN3BaseFileAccess'ten taşındı)
