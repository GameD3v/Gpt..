...
//#else
	...
	m_iFileFormatVersion = 0; // Yeni eklediðimiz format sürümünü baþlat
}
...
//#else
	...
	m_iFileFormatVersion = 0; // Yeni eklediðimiz deðiþkeni sýfýrl
}
...
#ifdef _DEBUG
		if(bFixed)
			::MessageBoxA(s_hWndBase, "Àß¸øµÈ Progressive Mesh ¼öÁ¤", m_szName.c_str(), MB_OK);
#endif
	}
